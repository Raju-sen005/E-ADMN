...
import AddEvent from "./pages/AddEvent"; // Importing AddEvent page
import EditEvent from "./pages/EditEvent"; // Importing EditEvent page
import AllEvents from "./pages/AllEvents"; // Importing AllEvents page
    ...
    <BrowserRouter>
      <LayoutWrapper>
        <Routes>
          ...
          <Route path="/add-event" element={<PrivateRoute><AddEvent /></PrivateRoute>} /> {/* AddEvent route */}
          <Route path="/events-all" element={<PrivateRoute><AllEvents /></PrivateRoute>} /> {/* AllEvents route */}
          <Route path="/edit-event/:id" element={<PrivateRoute><EditEvent /></PrivateRoute>} /> {/* EditEvent route */}
        </Routes>
      </LayoutWrapper>
    </BrowserRouter>
  );
