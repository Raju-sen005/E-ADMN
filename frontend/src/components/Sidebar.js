        ...
        <div className="sb2-1">
            ...
            <div className="sb2-13">
                <ul className="collapsible" data-collapsible="accordion">
                    ...
                    <li><Link to="#" className="collapsible-header"><i className="fa fa-rss" aria-hidden="true"></i>Events</Link>
                        <div className="collapsible-body left-sub-menu">
                            <ul>
                                <li><Link to="/events-all">All Events</Link>
                                </li>
                                <li><Link to="/add-event">Add Events</Link>
                                </li>
                            </ul>
                        </div>
                    </li>
